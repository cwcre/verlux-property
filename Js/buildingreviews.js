...
vExplore.addEventListener("mouseover", function() {
    ...
    vMenu.innerHTML = `
    <ul class ="menu_list">
    <li class="menu_links2"><a data-i18n ="buildingReviews" class="menu_a2 on-page" href="buildingreviews.html">Building Reviews</a></li>
...
const translations = {
    en: {
        ...
        explore: "Explore",
        pageHeading: "Building reviews",
        pageSpan: "Find out more about your new home. Read reviews and ratings from real residents.",
        pageH2: "Top reviewed buildings in the UAE",
        pageH3: "Last reviews",
        serachBtn: "Show reviews",
        footerLi1: "About us",
    ...
    ar: {
        ...
        explore: "إكتشف",
        pageHeading: "مراجعات البناء",
        pageSpan: "اكتشف المزيد عن منزلك الجديد. قراءة التقييمات والتقييمات من المقيمين الحقيقيين.",
        pageH2: "أعلى المباني تقييما في دولة الإمارات العربية المتحدة",
        pageH3: "آخر التقييمات",
        serachBtn: "اظهر المراجعات",
...
const setLanguage = (language) => {
    ...
    if (language === 'ar') {
        ...
        vExplore.addEventListener("mouseover", function() {
            ...
            vMenu.innerHTML = `
            <ul class ="menu_list">
            <li class="menu_links2"><a data-i18n ="buildingReviews" class="menu_a2 on-page" href="buildingreviews.html">تقييمات البناء</a></li>
